...
L_GUI_CHAT_FADING = "Chat message fading (disable to keep messages always visible)"
...
L_GUI_GENERAL_MULTISAMPLE_CHECK = "Multisampling protection (helps ensure clean crisp borders)"
L_GUI_GENERAL_REPLACE_BLIZZARD_FONTS = "Replaces the default |cff00B4FFBlizzard fonts|r on various panels and frames from |cff388bdbbudsUI|r."
...
L_GUI_MINIMAP_PING = "Displays a message when someone pings the minimap. |cfff02c35*|r |ccfabd473Kkthnx|r |cfff02c35*|r"
-- Misc Localization
...
L_GUI_POWERBAR_SHOW_MAELSTROM = "Show |cff00B4FFMaelstrom Weapon|r tracker"
L_GUI_POWERBAR_MAELSTROM_SIZE = "|cff00B4FFMaelstrom|r icon size (default 256)"
L_GUI_POWERBAR_MAELSTROM_PULSE = "Pulse animation at stack threshold"
L_GUI_POWERBAR_MAELSTROM_PULSE_AT = "|cff00B4FFMaelstrom|r pulse at X stacks"
...
L_GUI_RESET_ALL = "Are you sure you want to reset all settings for |cff388bdbbudsUI|r."
...
L_GUI_UNITFRAME_ENABLE = "Use |cff388bdbbudsUI|r Player, Target & Focus layout."
