...
L_GUI_GENERAL_MULTISAMPLE_CHECK = "Ensure crisp borders (Reduce Antialiasing)"
L_GUI_GENERAL_REPLACE_BLIZZARD_FONTS = "Replace all default fonts with |cff388bdbbudsUI|r fonts"
