...
L_GUI_GENERAL_REPLACE_BLIZZARD_FONTS = "Заменить шрифт Blizzard на различных панелях и фреймах |cff388bdbbudsUI|r."
...
L_GUI_MINIMAP_PING = "Выводить сообщение о задержке с ником игрока на миникарте. |cfff02c35*|r |ccfabd473Kkthnx|r |cfff02c35*|r"
...
L_GUI_RESET_ALL = "Вы уверены, что хотите сбросить все настройки |cFF4488FFbudsUI|r?"
