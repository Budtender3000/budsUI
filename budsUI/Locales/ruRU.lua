...
L_ADDON_LIST = "|cff388bdbСписок аддонов|r"
...
L_INFO_SETTINGS_ALL = "Введите |cff388bdb/settings all|r|cffE8CB3B, чтобы применить настройки для всех поддерживаемых аддонов"
L_INFO_SETTINGS_BIGWIGS = "Введите |cff388bdb/settings bigwigs|r|cffE8CB3B, чтобы применить настройки |cff388bdbBigwigs|r"
L_INFO_SETTINGS_BT4 = "Введите |cff388bdb/settings bartender4|r|cffE8CB3B, чтобы применить настройки |cff388bdbBartender4|r"
L_INFO_SETTINGS_BUTTONFACADE = "Введите |cff388bdb/settings bfacade|r|cffE8CB3B, чтобы применить настройки |cff388bdbButtonFacade|r"
L_INFO_SETTINGS_CHATCONSOLIDATE = "Введите |cff388bdb/settings chatfilter|r|cffE8CB3B, чтобы применить настройки |cff388bdbChatConsolidate|r"
L_INFO_SETTINGS_CLASSCOLOR = "Введите |cff388bdb/settings color|r|cffE8CB3B, чтобы применить настройки |cff388bdb!ClassColor|r."
L_INFO_SETTINGS_CLASSTIMER = "Введите |cff388bdb/settings classtimer|r|cffE8CB3B, чтобы применить настройки |cff388bdbClassTimer|r"
L_INFO_SETTINGS_MAPSTER = "Введите |cff388bdb/settings mapster|r|cffE8CB3B, чтобы применить настройки |cff388bdbMapster|r"
L_INFO_SETTINGS_MSBT = "Введите |cff388bdb/settings msbt|r|cffE8CB3B, чтобы применить настройки |cff388bdbMikScrollingBattleText|r"
L_INFO_SETTINGS_PLATES = "Введите |cff388bdb/settings nameplates|r|cffE8CB3B, чтобы применить настройки |cff388bdbNameplates|r"
L_INFO_SETTINGS_SKADA = "Введите |cff388bdb/settings skada|r|cffE8CB3B, чтобы применить настройки |cff388bdbSkada|r"
L_INFO_SETTINGS_THREATPLATES = "Необходимо изменить положение элементов |cff388bdbTidyPlates_ThreatPlates|r"
L_INFO_SETTINGS_XLOOT = "Введите |cff388bdb/settings xloot|r|cffE8CB3B, чтобы применить настройки |cff388bdbXLoot|r"
-- Loot Localization
...
-- Map Localization
L_MAP_FARMMODE = "|cff388bdbРежим фарма|r"
-- FarmMode Minimap
...
-- Misc Localization
L_MISC_UI_OUTDATED = "Ваша версия |cff388bdbbudsUI|r устарела. Вы можете скачать последнюю версию с www.github.com/Kkthnx"
L_MISC_UNDRESS = "Снять"
-- Popup Localization
L_POPUP_ARMORY = "|cffE8CB3BАрмори|r"
L_POPUP_INSTALLUI = "|cff388bdbbudsUI|r впервые с этим персонажем. Вы должны перезагрузить пользовательский интерфейс, чтобы настроить его."
L_POPUP_RESETUI = "Вы уверены, что хотите сбросить все настройки |cff388bdbbudsUI|r?"
L_POPUP_RESTART_GFX = "|cfff02c35ВНИМАНИЕ:|r Множественная выборка пользовательского интерфейса работает некорректно, границы могут быть нечеткими.|n|nИсправить это?"
L_POPUP_SETTINGS_ALL = "Применить настройки для всех поддерживаемых аддонов? |n|n|cff388bdbРекомендуется!|r"
L_POPUP_SETTINGS_BW = "Необходимо изменить положение элементов |cff388bdbBigWigs|r."
L_POPUP_SETTINGS_DBM = "Нам нужно изменить позицию баров |cff388bdbDBM|r."
L_POPUP_BOOSTUI = "|cfff02c35ВНИМАНИЕ:|r Это позволит оптимизировать производительность за счет снижения уровня графики. Применяйте только если у вас возникли проблемы с |cfff02c35FPS|r!|r"
L_POPUP_RELOADUI = "Установка завершена. Пожалуйста, нажмите кнопку 'Принять' для перезагрузки UI. Наслаждайтесь |cff388bdbbudsUI|r!|n|nПосетите мою страницу: |cff388bdbwww.github.com/kkthnx|r!"
...
L_STATS_SYSTEMLEFT = "|cff388bdbЛКМ: Поиск подземелий|r"
L_STATS_SYSTEMRIGHT = "|cff388bdbПКМ: Очистить память|r"
...
L_WELCOME_LINE_1 = "Добро пожаловать в |cff388bdbbudsUI|r "
L_WELCOME_LINE_2_1 = ""
L_WELCOME_LINE_2_2 = "Введите |cff388bdb/uihelp|r или |cff388bdb/cfg|r для настройки интерфейса"
-- Slash Commands Localization
L_SLASHCMD_HELP = {
	"|cff388bdbДоступные команды:|r",
	"|cff388bdb/cfg|r - |cffE8CB3BОткрыть настройки|r |cff388bdbbudsUI|r.",
	"|cff388bdb/kb|r - |cffE8CB3BНазначение клавиш|r |cff388bdbbudsUI|r.",
	"|cff388bdb/align|r - |cffE8CB3BРазмерная сетка.",
	"|cff388bdb/bigchat|r - |cffE8CB3BУвеличение окна чата.",
	"|cff388bdb/clc, /clfix|r - |cffE8CB3BСброс журнала боя, при поломках.",
	"|cff388bdb/clearchat, /cc|r - |cffE8CB3BОчищает выбранное окно чата.",
	"|cff388bdb/clearquests, /clquests|r - |cffE8CB3BПолное удаление всех ваших заданий.",
	"|cff388bdb/dbmtest|r - |cffE8CB3BЗапустить проверку Deadly Boss Mods.",
	"|cff388bdb/farmmode|r - |cffE8CB3BУвеличение размера миникарты.",
	"|cff388bdb/frame|r - |cffE8CB3BПоказывает информацию о фрейме под курсором.",
	"|cff388bdb/fs|r - |cffE8CB3BПоказать Framestack. Полезно для разработчиков.",
	"|cff388bdb/gm|r - |cffE8CB3BОткрыть окно связи с ГМ'ом.",
	"|cff388bdb/moveui|r - |cffE8CB3BПозволяет перемещать элементы интерфейса.",
	"|cff388bdb/rc|r - |cffE8CB3BАктивирует проверку готовности.",
	"|cff388bdb/rd|r - |cffE8CB3BРаспустить группу или рейд.",
	"|cff388bdb/resetconfig|r - |cffE8CB3BСбросить настройки |cff388bdbbudsUI|r.",
	"|cff388bdb/resetui|r - |cffE8CB3BСброс общих настроек по умолчанию.",
	"|cff388bdb/rl|r - |cffE8CB3BПерезагрузить интерфейс.",
	"|cff388bdb/settings ADDON_NAME|r - |cffE8CB3BПриминение настроек для msbt, dbm, skada, или других аддонов.",
	"|cff388bdb/spec, /ss|r - |cffE8CB3BПереключение между ветками талантов.",
	"|cff388bdb/teleport|r - |cffE8CB3BТелепортация из случайного подземелья",
	"|cff388bdb/testa|r - |cffE8CB3BТест панелей оповещения Blizzard.",
	"|cff388bdb/toparty, /toraid, /convert|r - |cffE8CB3BПростой перевод группы в рейд.",
	"|cff388bdb/tt|r - |cffE8CB3BСообщение цели.",
	"|cff388bdb/pc|r - |cffE8CB3BАктивация обратного отсчета на запуск босса.",
}