...
title:SetText("|cff388bdbAddonList|r")
...
-- WoW 3.3.5 Compatibility: GameMenuFrame and related buttons don't exist in WoW 3.3.5
-- This entire menu integration block is skipped on older versions, but the addon list
-- remains fully accessible via the /addons slash command above
if GameMenuFrame then
	...
	-- WoW 3.3.5 Compatibility: GameMenuButtonMacros doesn't exist in 3.3.5
	-- If the anchor button is missing, the addon list button will use default positioning
	...
	-- WoW 3.3.5 Compatibility: GameMenuButtonLogout doesn't exist in 3.3.5
	-- If the logout button is missing, we skip repositioning it to maintain menu layout
